...
(function($) {
    ...
    **/
    var launch = new Date(2016, 02, 01, 11, 00);
    /**
    * The script
    **/
    var message = $('#message');
    ...
    function setDate(){
        ...
        if( launch < now ){
            ...
            message.html('NUESTRO SITIO NO ESTÁ DISPONIBLE AÚN...');
        }
        else{
            ...
            message.html('NUESTRO SITIO NO ESTÁ DISPONIBLE AÚN, ESPERALO MUY PRONTO.');
        }
    }
})(jQuery);
/******************************************************************************************************************************
